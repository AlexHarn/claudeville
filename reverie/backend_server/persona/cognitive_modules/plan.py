...
from persona.prompt_template.claude_structure import ChatGPT_single_request
...
def generate_new_decomp_schedule(
    ...
    _ = persona.name  # noqa: F841 - kept for debugging
...
def _chat_react(maze, persona, focused_event, reaction_mode, personas):
    ...
    _ = [init_persona, target_persona]  # noqa: F841 - kept for debugging
